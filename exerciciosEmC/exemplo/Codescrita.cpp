...
// codigo que abre o arquivo, o nome do arquivo esta na variavel argv[1] q foi passado no cmd
// w = instrução que abriu o arquivo para gravação
